...
import { 
  ...
  Zap, Volume2, Signal, Target, Clock, Gauge
} from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Progress } from "@/components/ui/progress";
import SeismicWaveform from "./SeismicWaveform";
import { indiaEarthquakes, type Earthquake } from "@/data/indiaEarthquakes";
...
const SeismicMonitoringDashboard = () => {
  ...
  const [selectedQuake, setSelectedQuake] = useState<Earthquake | null>(earthquakes[0] || null);
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Seismic analysis • Waveforms • Ground acceleration • Signal processing
            </p>
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">{quake.location}</p>
                        </div>
                      </div>
